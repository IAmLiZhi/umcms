<@ms.html5>
	...
	<@ms.panel>
		<@shiro.hasPermission name="mwebsite:template:upload"><@ms.myuploadFile path="" uploadFloderPath="templets/${websiteId}/" inputName="websiteStyle" size="10" filetype="*.zip" msg="建议上传30M以下的zip文件,模版名称不能使用中文,zip的压缩方式为:存储"  maxSize="30" callBack="setUrl" isRename="false"/></@shiro.hasPermission> 
           		...
           		<#list folderNameList as folderName>
		        	<tr> 
			            ...
			            <td style="width:10%;text-align:center">
	                    	...
	                    	<a  class="btn btn-xs tooltips" href="${managerPath}/mwebsite/template/showChildFileAndFolder.do?websiteId=${websiteId}&skinFolderName=templets/${websiteId}/${folderName}" data-toggle="tooltip" target="_self" data-original-title="打开文件夹" >
	...
	<script type="text/javascript">
       ...
       function setUrl(e){
		...
		$("#deleteButton").click(function(){
			var URL = base+"${baseManager}/mwebsite/template/delete.do?websiteId="+websiteId;
