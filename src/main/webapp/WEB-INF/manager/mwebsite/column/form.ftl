...
<script>
$(function(){
	<#--  console.log($('#ms__uploadPic_categorySmallImg'));  -->
	$('#ms__uploadPic_categorySmallImg').parent().parent().css('display', 'none');
	...
	$.ajax({
	   type: "post",
	   dataType: "json",
	   url:  "${managerPath}/${model?default("")}/template/queryTemplateFileForColumn.do?websiteId=${websiteId}",
	...
	$("#backButton").click(function(){
	    ...
	    location.href="${managerPath}/${model?default("")}/column/index.do?websiteId=${websiteId}&modelId=${Session.model_id_session?default(0)}&modelTitle=${Session.model_title_session?default('')}";
	})
	...
	$("#saveUpdate").click(function(){
		...
		var URL = "";
		<#if column.categoryId==0>
		URL ="${managerPath}/${model?default("")}/column/save.do?websiteId=${websiteId}&modelId=${Session.model_id_session?default(0)}&modelTitle=${Session.model_title_session?default('')}";
		<#else>
		URL = "${managerPath}/${model?default("")}/column/update.do?websiteId=${websiteId}&modelId=${Session.model_id_session?default(0)}&modelTitle=${Session.model_title_session?default('')}";
		</#if>
	...
	$.ajax({
		type: "post",
		url: "${managerPath}/mdiy/contentModel/list.do?websiteId=${websiteId}&pageSize=100",
		dataType: "json",
