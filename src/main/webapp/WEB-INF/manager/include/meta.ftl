...
<script type="text/javascript" src="${static}/plugins/jquery/3.7/jquery.js"></script> 
...
<script type="text/javascript" src="${static}/skin/manager/${manager_ui}/js/md5.js"></script>
...
<script type="text/javascript" src="${static}/plugins/tableExport/tableExport.min.js"></script>
<!--
<script type="text/javascript" src="${static}/plugins/tableExport/libs/jsPDF/jspdf.min.js"></script>
<script type="text/javascript" src="${static}/plugins/tableExport/libs/jsPDF-AutoTable/jspdf.plugin.autotable.js"></script>
-->
<script type="text/javascript" src="${static}/plugins/bootstrap-table/1.11.1/extensions/export/bootstrap-table-export.min.js"></script>
...
<#if manager_session?exists>
  ...
  <!--[if lt IE 9]>
    <script src="${static}/skin/manager/${manager_ui}/js/html5shiv.min.js"></script>
    <script src="${static}/skin/manager/${manager_ui}/js/respond.min.js"></script>
  <![endif]-->
