...
<#macro select
	...
	select2=false
	>
<div class="form-group ms-form-group" id="myselect">	
	<#include "control.ftl"/><#rt/>
	<div class="col-sm-9 ms-form-control ms-from-group-input" id="myfromgroupinput" <#if width!=""> style="width:${width}px"</#if><#rt/>>
		<select<#rt/>
		<#if id!=""> id="${id}"</#if><#rt/>
