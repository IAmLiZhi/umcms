...
<title>西藏教育站群管理系统</title>
<#--  <link rel="shortcut icon" href="${static}/global/images/ms.ico"/>  -->
<#--  <link rel="bookmark" href="${static}/global/images/ms.icoo"/>  -->
<script type="text/javascript" src="${static}/plugins/vue/2.3.3/vue.min.js"></script>
<script type="text/javascript" src="${static}/plugins/validator/5.5.0/validator.min.js"></script>
<link rel="stylesheet/less" type="text/css" href="${static}/skin/manager/${manager_ui}/less/login.less" media="all" />
<script type="text/javascript" src="${static}/plugins/less/2.5.3/less.min.js" ></script>
                ...
                <form class="form-horizontal" id="loginForm" action="${managerPath}/checkLogin.do">
                    ...
                    <div class="login-code">
                        ...
                        <p class="login-float login-code-text">
                            <span>看不清?</span><br/>
                            <span class="login-code-change" @click="changeCode">换一张</span>
                        </p>
                    </div>
            ...
            methods:{
                ...
                login:function(){
		            ...
		            if(this.isRight){
				        ...
				        $(this).myPostForm("#loginForm",{loadingText:"正在登录中..",func:function(data) {
    				        if(data.result){
    					        location.href=base+"${baseManager}/index.do";
                            }else{
                                if(data.resultMsg == '系统不存在此用户')
                                    alert('用户名或密码错误');
                                else
