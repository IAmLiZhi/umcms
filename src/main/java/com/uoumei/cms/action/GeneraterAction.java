...
//			
//			if(folderExists(tmpPath+ File.separator + PathUtil.FOLDER_NAME_CSS)){
//				SyncStarter.sync(tmpPath+ File.separator + PathUtil.FOLDER_NAME_CSS, 
//						staticFolder+ File.separator + PathUtil.FOLDER_NAME_CSS);
//			}
//			if(folderExists(tmpPath+ File.separator + PathUtil.FOLDER_NAME_IMAGE)){
//				SyncStarter.sync(tmpPath+ File.separator + PathUtil.FOLDER_NAME_IMAGE, 
//						staticFolder+ File.separator + PathUtil.FOLDER_NAME_IMAGE);
//			}
//			if(folderExists(tmpPath+ File.separator + PathUtil.FOLDER_NAME_JS)){
//				SyncStarter.sync(tmpPath+ File.separator + PathUtil.FOLDER_NAME_JS, 
//						staticFolder+ File.separator + PathUtil.FOLDER_NAME_JS);
//			}
//			if(folderExists(tmpPath+ File.separator + PathUtil.FOLDER_NAME_FLASH)){
//				SyncStarter.sync(tmpPath+ File.separator + PathUtil.FOLDER_NAME_FLASH, 
//						staticFolder+ File.separator + PathUtil.FOLDER_NAME_FLASH);
//			}
//			if(folderExists(tmpPath+ File.separator + PathUtil.FOLDER_NAME_FONT)){
//				SyncStarter.sync(tmpPath+ File.separator + PathUtil.FOLDER_NAME_FONT, 
//						staticFolder+ File.separator + PathUtil.FOLDER_NAME_FONT);
//			}
