...
import com.uoumei.base.constant.e.BaseCookieEnum;
import com.uoumei.base.constant.e.BaseEnum;
import com.uoumei.base.constant.e.BaseSessionEnum;
...
public class BasicUtil extends BaseUtil {
	...
	public static int getModelCodeId(BaseEnum code) {
		com.uoumei.basic.biz.IModelBiz modelBiz = (com.uoumei.basic.biz.IModelBiz) SpringUtil
	...
	// --zzq
	public static void startPageHtml(int pageNo, int pageSize, boolean count) {
	...
	//--zzq
	@SuppressWarnings("rawtypes")
	public static PageInfo endPageHtml(List list) {
		PageInfo page = new PageInfo(list);
		return page;
	}
